...
(function () {
  const container = document.getElementById('slider01-container');

  if (container) {
    let html = '';
    slider01Data.forEach(function (item) {
      html += `<div class="slider-item style-card">
                    <div class="slider-inner equal-element" style="background-image: url(images/${item.id}-slider01.jpg)">
    ...
    throw new Error('Element with id "slider01-container" not found');
  }
})();
